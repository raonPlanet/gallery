          ...
          <div class="col-md-5 col-lg-4 order-md-last"><h4
            ...
            <ul class="list-group mb-3">
              <li class="list-group-item d-flex justify-content-between lh-sm" v-for="(i,idx) in state.items"
                ...
                <span class="text-body-secondary">{{ lib.getNumberFormatted(i.price * i.discountPer / 100) }}원</span>
              </li>
            </ul>
          ...
          <div class="col-md-7 col-lg-8"><h4 class="mb-3">주문자 정보</h4>
            <div class="needs-validation" novalidate="">
              ...
              <div class="my-3">
                ...
                <div class="form-check">
                  <input id="bank" value="bank" name="paymentMethod" type="radio" class="form-check-input"
...
export default {
  setup() {
    ...
    const submit = ()=>{
      // 참조값의 연결고리를 끊기 위해서 JSON.stringfy-> JSON.parse 사용
